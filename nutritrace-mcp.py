...
TOOLS = [
    ...
    {"name":"nutritrace_diary_delete","description":"Delete a diary food entry for a date. Provide food_server_id from diary_get. Optional meal filter (0=breakfast,1=lunch,2=dinner,3=snacks).","inputSchema":{"type":"object","properties":{"date":{"type":"string"},"food_server_id":{"type":"integer"},"meal":{"type":"integer"}},"required":["date","food_server_id"]}},
    {"name":"nutritrace_diary_update","description":"Update a diary food entry quantity or meal for a date. Provide food_server_id from diary_get.","inputSchema":{"type":"object","properties":{"date":{"type":"string"},"food_server_id":{"type":"integer"},"quantity":{"type":"number"},"meal":{"type":"integer"}},"required":["date","food_server_id"]}},
